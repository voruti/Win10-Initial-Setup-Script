...
Function DownloadCCleaner {
	...
	$programUrl = "https://download.ccleaner.com/portable/ccsetup628.zip" # https://www.ccleaner.com/de-de/ccleaner/builds # manualUpdate
...
Function DownloadNodeJs {
	...
	$programUrl = "https://nodejs.org/dist/v20.18.0/node-v20.18.0-win-x64.zip" # https://nodejs.org/en/download/ # manualUpdate
...
Function InstallNodeJs {
	...
	Rename-Item "$programDirectory\..\node-v20.18.0-win-x64" $programDirectory # manualUpdate
