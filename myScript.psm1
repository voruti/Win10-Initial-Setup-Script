...
Function DownloadCCleaner {
	...
	$programUrl = "https://download.ccleaner.com/portable/ccsetup617.zip" # https://www.ccleaner.com/de-de/ccleaner/builds # manualUpdate
...
Function DownloadMailCheck {
	...
	$programUrl = "https://www.d-jan.de/MailCheck2Setup131Build551-64bit.exe" # https://www.d-jan.de/download.shtml # manualUpdate
...
Function DownloadNodeJs {
	...
	$programUrl = "https://nodejs.org/dist/v20.9.0/node-v20.9.0-win-x64.zip" # https://nodejs.org/en/download/ # manualUpdate
...
Function InstallNodeJs {
	...
	Rename-Item "$programDirectory\..\node-v20.9.0-win-x64" $programDirectory # manualUpdate
